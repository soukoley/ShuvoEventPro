	...
	require 'AmountToWord/amountword.php';
		...
		class PDF extends FPDF{
			...
			function Header(){
				...
				$this->Rect(4,5,208,24.5,'D');			
				$this->SetFont('arial', "B", 14);
				//$this->Image("../images/logo.jpeg",58,6,100,15);
				$this->SetXY(175,5);
				$this->SetFont('arial', "B", 9);
				$this->Cell(37,6,$this->copy,1,0,'C',0);
				
				$this->SetXY(20,20);
				$this->SetFont('arial', "", 9);
				$this->Cell(80,5,"Office : Changghurali, Maju, Howrah-711414",'',0,'R',0);
				$this->SetX(115);
				$this->Cell(190,5,"Godown: Pantihal, Jadupur, Howrah-711410",'',0,'L',0);
				$this->SetFont('arial', "", 8.5);
				$this->Ln(4.5);
				$this->Cell(37,5,"www.kirangroups.in",'',0,'R',0);
				$this->SetX(60);
				$this->Cell(85,5,"Mobile : 8777787749, 9748844999, 9830402529, 9831981447",'',0,'C',0);
				$this->SetX(157);
				$this->Cell(40,5,"Email : kiran@kirangroups.in",'',0,'L',0);
				
				$this->Rect(4,29.5,108,12,'D');
				$this->Rect(112,29.5,100,12,'D');
				$this->SetXY(6,30);
				$this->SetFont('arial', "B", 11);
				$this->Cell(75,5,"To, M/s ".$this->b_name,'',0,'L',0);
				$this->SetFont('arial', "", 9);
				$this->Cell(1,5,"Mobile : ",'',0,'R',0);
				$this->Cell(19,5,$this->b_contact,'',0,'R',0);				// Buyer's Phone no
				//$this->SetXY(6,32);
			...
			function Footer(){
				...
				$this->Rect(4,140,208,25,'D');	//Rect($x, $y, $w, $h, $style='')
				$this->SetXY(6,141);
		...
		//$pdf = new PDF("P", "mm", array(210,149));	// custom paper size...use array instead of the name of paper size.
