...
if(isset($_GET['edit_p_cat'])){
	...
	$p_cat_img=$row_edit['product_img1'];
}
				...
				<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<br><img src="product_images/<?php echo $p_cat_img; ?>" width="70" height="70">
						</div>
					</div>
					<div class="form-group">
...
if(isset($_POST['update'])){
	...
	$update_p_cat="update product_category set p_cat_title='$p_cat_title', p_cat_desc='$p_cat_desc', product_img1='$product_img1'  where p_cat_id='$p_cat_id'";
