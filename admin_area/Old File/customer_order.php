				...
				<div class="table-responsive">
					<table class="table table-borderd table-hover table-striped">
						...
						<tbody>
							<?php 
							$i=0;
							$get_order="select order_id, customer_id, invoice_no, order_date, SUM(due_amount) AS due_amount1, order_status from customer_order where customer_id='$customer_id'  group by invoice_no order by order_date ";
