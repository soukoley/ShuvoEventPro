					...
					<div class="panel-body">
						<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<select name="cat_id" class="form-control" required="">
										...
										<?php 
										$get_p="select * from categories order by cat_title";
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input type="number" name="m_price" step="0.0001" class="form-control" required="">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">Sale Price :</label>
								<div class="col-md-6">
									<input type="number" name="s_price" step="0.0001" class="form-control" required="">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">Purchase Price :</label>
								<div class="col-md-6">
									<input type="number" name="p_price" step="0.0001" class="form-control" required="">
								</div>
							</div>
							<div class="form-group">
...
if(isset($_POST['submit'])){
	...
	$query="select * from stock where cat_title='$cat_id'";
	...
	$insert_purchase="insert into purchase(cat_id,m_price,s_price,p_price,qty,p_inv,p_from,p_date) values('$cat_id','$m_price','$s_price','$p_price','$FQTY','$p_inv', '$p_from','$p_date')";
	$run_purchase=mysqli_query($con,$insert_purchase);
	if($run_purchase){
		$update_stock="update stock set m_price='$fm_price', s_price='$fs_price', p_price='$fp_price', qty='$FQTY' where stock_id='$stock_id'";
