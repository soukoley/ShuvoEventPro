...
if(isset($_POST['submit'])){
	...
	$insert_product="insert into products(p_cat_id,cat_id,product_title,company,product_img1,m_price,s_price,p_price,value,product_keyword) values('$product_cat','$cat','$product_title','$company','$product_img1','$m_price','$s_price','$p_price','$val','$product_keywords')";
	//echo $insert_product;
	$run_product=mysqli_query($con,$insert_product);
	if($run_product){
		$qty=0;
		$insert_stock="insert into stock(p_cat_id,cat_id,product_title,company,product_img1,m_price,s_price,p_price,value,qty) values('$product_cat','$cat','$product_title','$company','$product_img1','$m_price','$s_price','$p_price','$val','$qty')";
	//echo $insert_product;
