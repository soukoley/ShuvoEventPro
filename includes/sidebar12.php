...
<nav class="navbar navbar-inverse navbar-fixed-top" style="background: black">
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		<ul class="nav navbar-nav sidebar-nav">
			...
			<li>
				<a href="#" data-toggle="collapse" data-target="#Event">
					<i class="fa fa-fw fa-table"></i> Event
					<i class="fa fa-fw fa-caret-down"></i>
				</a>
				<ul id="Event" class="collapse">
					<li>
						<a href="index.php?insert_event">New Event</a>
					</li>
					<li>
			...
			<li>
				<a href="#" data-toggle="collapse" data-target="#Lottery">
					<i class="fa fa-fw fa-table"></i> Lottery
					<i class="fa fa-fw fa-caret-down"></i>
				</a>
				<ul id="Lottery" class="collapse">
					<li>
						<a href="index.php?lottery">Monthly Lottery</a>
					</li>
					<li>
						<a href="index.php?view_lottery">View Lottery</a>
					</li>
